...
class SparkLineView(ListView):
    template_name = 'sparkline.html'
...
def multipleBarbySeverity(request):
    ...
    SELECT 
        ...
        COUNT(fi.id) AS incident_count
    FROM 
        fire_incident fi  -- Make sure the table name matches your actual table name
    GROUP BY fi.severity_level, month
    ORDER BY fi.severity_level, month
    '''
...
def map_incidents(request):
    incidents = Incident.objects.values('location__name', 'location__latitude', 'location__longitude', 'severity_level')
...
def get_incident_sparkline_data(request):
